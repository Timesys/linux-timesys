...
#define MVF600_I2C_PAD_CTRL      (PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP | \
...
#define MVF600_PAD37_PTB15__I2C0_SDA				\
		IOMUX_PAD(0x0094, 0x0094, 2, 0x0340, 1, \
				MVF600_I2C_PAD_CTRL | PAD_CTL_OBE_IBE_ENABLE)
/*I2C2*/
#define MVF600_PAD12_PTA22__I2C2_SCL				\
		IOMUX_PAD(0x0030, 0x0030, 6, 0x034C, 0, \
				MVF600_I2C_PAD_CTRL | PAD_CTL_OBE_IBE_ENABLE)
#define MVF600_PAD13_PTA23__I2C2_SDA				\
		IOMUX_PAD(0x0034, 0x0034, 6, 0x0350, 0, \
				MVF600_I2C_PAD_CTRL | PAD_CTL_OBE_IBE_ENABLE)
/*CAN0*/
...
#define MVF600_PAD11_PTA21_SAI2_RX_BCLK			\
		IOMUX_PAD(0x002C, 0x002C, 5, 0x0364, 0, \
				MVF600_SAI_PAD_CTRL | PAD_CTL_IBE_ENABLE)
#define MVF600_PAD23_PTB1_SAI2_RX_DATA			\
		IOMUX_PAD(0x005C, 0x005C, 5, 0x0368, 1, \
				MVF600_SAI_PAD_CTRL | PAD_CTL_IBE_ENABLE)
#define MVF600_PAD24_PTB2_SAI2_RX_SYNC			\
		IOMUX_PAD(0x0060, 0x0060, 5, 0x036c, 1, \
				MVF600_SAI_PAD_CTRL | PAD_CTL_IBE_ENABLE)
